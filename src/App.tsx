          ...
          {stage === STAGES.ABOUT && (
            ...
            >
              ...
              <motion.div
                ...
                className="fixed top-0 left-1/2 -translate-x-1/2 flex flex-row items-center gap-2 pointer-events-none z-50 h-14"
              >
                <motion.div className="w-8 h-[1px] bg-white/20 overflow-hidden relative">
