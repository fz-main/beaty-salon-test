...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    transition: 'https://res.cloudinary.com/dfh97tdty/video/upload/v1779640822/First-Person_POV_Video_A_man_with_dark_hair_and_a_light_complexion_S1g9qRMo_otd8mv.mp4',
    price: '1,800 CZK',
    time: '60 min',
    position: [10, 0, -10],
    color: '#d4c5b0'
