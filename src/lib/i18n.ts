...
export const translations = {
  cs: {
    ...
    aboutBio: 'Z Moldavska, v Praze od roku 2001. Začínala jako mistryně manikúry a pedikúry, od roku 2012 vede vlastní salon. Specializuje se na permanentní makeup, prodlužování řas, epilaci a kosmetické procedury.',
  ...
  en: {
    ...
    aboutBio: 'Originally from Moldova, living in Prague since 2001. Started as a manicure and pedicure master, running her own salon since 2012. Specializes in permanent makeup, eyelash extensions, epilation and cosmetic procedures.',
  ...
  de: {
    ...
    aboutBio: 'Aus Moldawien, seit 2001 in Prag. Begann als Maniküre- und Pediküre-Meisterin, führt seit 2012 ihren eigenen Salon. Spezialisiert auf permanentes Make-up, Wimpernverlängerung, Epilation und Kosmetikbehandlungen.',
